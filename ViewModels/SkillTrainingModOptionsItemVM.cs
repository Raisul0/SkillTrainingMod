...
{
    public class SkillTrainingModOptionsItemVM : ViewModel
    {
        ...
        private Action<SkillTrainingModOptionsItemVM> _onValueChanged;

        private ModOptionDataType _dataType;
        ...
        public IModOptionsData OptionData { get; private set; }
        ...
        public SkillTrainingModOptionsItemVM(IModOptionsData optionData)
        {
            ...
            else if (_dataType == ModOptionDataType.Selection)
            {
            ...
            else if (_dataType == ModOptionDataType.Action)
            {
        ...
        public void SetOnValueChangedCallback(Action<SkillTrainingModOptionsItemVM> onValueChanged)
        {
